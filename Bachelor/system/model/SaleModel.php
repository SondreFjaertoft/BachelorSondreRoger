...
class SaleModel {
    ...
    const SELECT_MY_SALES = "SELECT * FROM " . SaleModel::TABLE . " WHERE userID = :givenUserID";
    ...
    public function getMySales($givenUserID){
         $this->mySales->execute(array("givenUserID" =>  $givenUserID));
